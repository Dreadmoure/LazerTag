...
{
    public class DiagonalRightProjectileFactory : Factory
    {
        #region singleton
        private static DiagonalRightProjectileFactory instance;
        public static DiagonalRightProjectileFactory Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new DiagonalRightProjectileFactory();
                }
                return instance;
            }
        }
        ...
        #region constructor
        /// <summary>
        /// private constructor for DiagonalRightProjectileFactory
        /// </summary>
        private DiagonalRightProjectileFactory()
        {
            CreatePrototype1();
            CreatePrototype2();
            CreatePrototype3();
        ...
        private void CreatePrototype1()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\RedDiagonalRight");
        ...
        private void CreatePrototype2()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\BlueDiagonalRight");
        ...
        private void CreatePrototype3()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\GreenDiagonalRight");
        ...
        private void CreatePrototype4()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\PinkDiagonalRight");
