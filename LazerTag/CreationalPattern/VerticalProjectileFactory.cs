...
{
    public class VerticalProjectileFactory : Factory
    {
        #region singleton
        private static VerticalProjectileFactory instance;
        public static VerticalProjectileFactory Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new VerticalProjectileFactory();
                }
                return instance;
            }
        }
        ...
        private void CreatePrototype1()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\RedV");
        ...
        private void CreatePrototype2()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\BlueV");
        ...
        private void CreatePrototype3()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\GreenV");
        ...
        private void CreatePrototype4()
        {
            ...
            spriteRenderer.SetSprite("Projectiles\\PinkV");
